...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    key: 'newDeltaCheck',
	    value: function newDeltaCheck() {
	      var newDelta = this.newDelta;
	    ...
	    key: 'snakeAndFruitCollision',
	    value: function snakeAndFruitCollision() {
	      var _this2 = this;

	      this.snake.pos.forEach(function (pos) {
	    ...
	    value: function gameOver() {
	      var snakeHead = this.snake.pos[0];
...
/***/ function(module, exports) {
	...
	var Snake = function () {
	  ...
	  _createClass(Snake, [{
	    key: "moveSnake",
	    value: function moveSnake(delta, fromFruit) {
	      if (!fromFruit) {
	        this.pos.pop();
	      }
